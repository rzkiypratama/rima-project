        ...
        <div className="container mx-auto justify-content-between">
          <section className={`${styles["cont-1"]} py-5`}>
            <div className="row d-flex justify-content-between flex-column-reverse flex-sm-column-reverse flex-md-column-reverse flex-lg-row ">
              <div className=" col-12 col-md-12 col-lg-3 ps-lg-0 col-sm-12 d-flex flex-md-row flex-wrap flex-lg-column align-items-center pt-5">
                {load !== "load" ? image.map((data) => <img className={`border-bottom  ${styles["img-left"]}`} src={data.image} key={data.id} alt="/" />) : <Loader />};
              </div>
              <div className=" col-12 col-md-12 col-sm-12 col-lg-8 ">
                {load === "load" ? <Loader /> : <img className={` w-100  ${styles["img-right"]}`} src={load} alt="/" />}
          ...
          <section className={`container  ${styles["cont-2"]}`}>
            ...
            <div className={`d-flex col-12 col-lg-12 col-md-12  align-items-center ${styles["cont-price"]}`}>
              <p className={` ${styles["price"]}`}>IDR.{costing(product.price)}</p>
              <img className={` ${styles["sold-out"]}`} src={checklist} alt="/"></img>
              <p className={` ${styles["stock"]}`}>
                {product.sold} Sold / {product.stock} In Stock
              </p>
            </div>
            <p className={`mt-5 ${styles["donec"]}`}>{product.description}</p>
            <div className="mt-5">
            ...
            <div className={`mt-0 mt-md-5 mt-lg-5 ${styles["Sku"]} `}>
              ...
              <p className={`${styles["SKU"]}`}> Categories: {product.category}</p>
              <p className={`${styles["SKU"]}`}> Tag: {product.category}</p>
              <p className={`${styles["SKU"]}`}> Modern Product ID: {product.id}</p>
            </div>
            ...
            <div className="row d-flex flex-sm-column mb-md-5 flex-md-row flex-lg-row">
              <section className={`${styles.content_left} d-flex align-items-center col-12 col-sm-12 col-md-6 col-lg-6 mb-5 mb-md-0 mb-lg-0 pe-0`}>{load === "load" ? <Loader /> : <img className="w-100" src={load} alt="sofa" />}</section>
