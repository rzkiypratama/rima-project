...
function Profile() {
  ...
  const SendRequest = (e) => {
    ...
    bodyFormDataProfile.append("address", address);
    console.log(bodyFormDataProfile);
    if (image !== profiles.image) bodyFormDataProfile.append("image", image);
    if (phone !== profiles.phone) bodyFormDataProfile.append("phone", phone);
    if (username !== profiles.username)
      bodyFormDataProfile.append("name", username);
    if (gender !== profiles.gender)
      bodyFormDataProfile.append("gender", gender);

    if (bodyFormDataProfile)
      dispatch(profileActions.updateProfileThunk(bodyFormDataProfile));
  };
