      ...
      {role !== "seller" ? null : (
        <div className=" container justify-content-evenly d-flex  my-5">
          ...
          <div className={`d-flex gap-2 align-items-center ${styles["cursor"]} ${styles["color"]}`}>
            <Link to={"/admin/my-product"} className={` text-decoration-none ${styles["no-underline"]}`}>
      ...
      <div className={`container d-flex mt-5 ${styles["cont-profile"]}`}>
        <span>
          <label htmlFor="images">
            <img className={`${styles["profile-picture"]} `} src={display} alt="/" />
          </label>
          {showInput ? null : <input type="file" id={"images"} className="d-none" onChange={inputImage} />}
        </span>
        ...
        <Modal.Body>
          <div className="w-100">
            <span>
              ...
              <br />
              <div className={styles["icon-eye"]}>{visible ? <i className="fa-regular fa-eye" onClick={togglePassword}></i> : <i className="fa fa-regular fa-eye-slash" onClick={togglePassword}></i>}</div>
              <input
                old_password
            ...
            <span>
              ...
              <br />
              <div className={styles["icon-eye-invisible"]}>{invisible ? <i className="fa-regular fa-eye" onClick={togglePwd}></i> : <i className="fa fa-regular fa-eye-slash" onClick={togglePwd}></i>}</div>
              <input
                id="newPassowrd"
