    ...
    <>
      <main className="container-fluid p-0">
        ...
        <section className={styles.home__bar}>
          ...
          <section className={` d-flex justify-content-center align-items-center p-0`}>
        ...
        <section className={`${styles.services__bar} text-center d-flex flex-column justify-content-around align-items-center`}>
          <div className="">
            ...
            <p className={`${styles.services__ceo}`}>Trevor Rivera - CEO IKEA</p>
          </div>
          <section className="d-flex flex-row justify-content-around flex-wrap w-100">
            <img width={150} className="p-3" src={backtowork} alt="backtowork" />
            <img width={150} className="p-3" src={furniture} alt="furniture" />
            <img width={150} className="p-3" src={furnitureoffice} alt="furnitureoffice" />
            <img width={150} className="p-3" src={workspace} alt="workspace" />
          </section>
        </section>
      </main>
      <Footer />
