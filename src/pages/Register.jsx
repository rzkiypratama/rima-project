...
function Regist() {
  ...
  const submitHandler = (e) => {
    ...
    setIsLoading(true);
    Axios.post(`${process.env.REACT_APP_BACKEND_HOST}/auth/register`, sendBody)
      .then((result) => {
          ...
          <div className="col-lg-5 col-12 justify-content-center">
            <div className={styles["form-verify"]}>
              <div className={styles["title-form-verify"]}>
                ...
                <p>
                  Thankyou for signup with us. To verify, we sent OTP to your
                  email
                </p>
              </div>
          ...
          <div className="col-lg-5 col-12 justify-content-center">
            <div className={styles["form-username"]}>
              <div className={styles["title-form-username"]}>
                ...
                <p>
                  Set {body.role === "customer" ? "username" : "store name"} and
                  start your journey at Rima Furniture
                </p>
              </div>
