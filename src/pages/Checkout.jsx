            ...
            <section className={`${styles.self__bar}`}>
               <div className="">
                  ...
                  <form className="pb-5">
                     ...
                     />
                     <div
                        className={`${styles["input_group"]} input-group mb-5`}
                     >
                        <select
                           className={`${styles.select_phone} form-select`}
                        >
                        ...
                        <input
                           className={`${styles.input_phone} w-75 form-control`}
                           type="tel"
                        />
                     </div>
                     <select
                        className={`${styles.select_bank} form-select mb-5`}
                     >
